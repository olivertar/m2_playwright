...
*Nota: Si el paquete está en un repositorio privado, añade `--repository-url="..."` al comando.*

### Opción B: Manual

Copia todo el contenido de esta carpeta (`playwright`) a la ruta `dev/tests/playwright` en tu proyecto Magento 2.
